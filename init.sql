...
(1, null, 1, '2015/07/12', 975000, 'MY COMMENT'),
(2, null, 1, '2015/07/12', 1200000, 'MY COMMENT2'),
(3, null, 1, '2015/07/12', 825000, 'MY COMMENT3'),
(4, null, 1, '2015/07/12', 930000, 'MY COMMENT4'),
(5, null, 1, '2015/07/12', 850000, 'MY COMMENT4'),
(6, null, 1, '2015/07/12', 725000, 'MY COMMENT4'),
(7, null, 1, '2015/07/12', 450000, 'MY COMMENT4'),
(1, null, 2, '2015/07/19', 975000, 'MY COMMENT'),
(2, null, 2, '2015/07/20', 1200000, 'MY COMMENT2'),
(3, null, 2, '2015/07/23', 825000, 'MY COMMENT3'),
(4, null, 2, '2015/07/18', 930000, 'MY COMMENT4'),
(5, null, 2, '2015/07/16', 850000, 'MY COMMENT4'),
(6, null, 2, '2015/07/15', 725000, 'MY COMMENT4'),
(7, null, 2, '2015/07/14', 450000, 'MY COMMENT4'),
(1, 9, 3, '2015/07/25', 975000, 'MY COMMENT'),
(2, 8, 3, '2015/07/26', 1200000, 'MY COMMENT2'),
(3, 7, 3, '2015/07/27', 825000, 'MY COMMENT3'),
(4, 6, 3, '2015/07/28', 930000, 'MY COMMENT4'),
(5, 4, 3, '2015/07/30', 850000, 'MY COMMENT4'),
(6, 2, 3, '2015/07/26', 725000, 'MY COMMENT4'),
(7, 1, 3, '2015/07/27', 450000, 'MY COMMENT4'),
(1, 7, 3, '2015/07/25', 975000, 'MY COMMENT'),
(2, 6, 3, '2015/07/26', 1200000, 'MY COMMENT2'),
(3, 5, 3, '2015/07/27', 825000, 'MY COMMENT3'),
(4, 3, 3, '2015/07/28', 930000, 'MY COMMENT4'),
(5, 8, 3, '2015/07/30', 850000, 'MY COMMENT4'),
(6, 2, 3, '2015/07/26', 725000, 'MY COMMENT4'),
(7, 1, 3, '2015/07/27', 450000, 'MY COMMENT4'),
(1, null, 2, '2015/08/02', 975000, 'MY COMMENT'),
(2, null, 2, '2015/08/03', 1200000, 'MY COMMENT2'),
(3, null, 2, '2015/08/04', 825000, 'MY COMMENT3'),
(4, null, 2, '2015/08/05', 930000, 'MY COMMENT4'),
(5, null, 2, '2015/08/06', 850000, 'MY COMMENT4'),
(6, null, 2, '2015/08/10', 725000, 'MY COMMENT4'),
(7, null, 2, '2015/08/11', 450000, 'MY COMMENT4'),
