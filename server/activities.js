...
function findAll(req, res, next) {
    ...
    db.query("SELECT activity_id, activity.property_id, activity.contact_id, contact.first_name as first_name, contact.last_name as last_name, activity_type.name as activity_name, activity_date, activity.price, comment FROM activity " +
             "INNER JOIN property on activity.property_id = property.property_id " +
             "INNER JOIN contact on activity.contact_id = contact.contact_id " +
